        ...
        <div className="d-flex justify-content-left mb-3 mt-3">
          ...
          <div className="dropdown ms-3">
            ...
            <div className="dropdown-menu" aria-labelledby="dropdownMenuButton" >
              <button
                data-testid="button-input1" className={`dropdown-item ${sortBy === "name" ? "active" : ""}`}
                onClick={() => handleSort("name")}
              >
                Name
              </button>
              <button
                 data-testid="button-input2" className={`dropdown-item ${sortBy === "date" ? "active" : ""}`}
          ...
          <div className="dropdown ms-3">
            ...
            <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
              ...
              <button
                className="dropdown-item"
                data-testid="status-incomplete-button"
                value="incomplete"
                onClick={handleStatus}
              >
                Incomplete
